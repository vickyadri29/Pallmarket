...
<body>
    ...
    if ($action == 'edit') {  //the user submitted the form
    ...
    $query = "SELECT * FROM barang WHERE id ='" . $mysqli->real_escape_string($_REQUEST['id']) . "' limit 0,1";
        ...
        <div id="input">
            ...
            <div id="penginputan">
                <form method="POST" enctype="multipart/form-data" class="inputdata">
                    ...
                    <td><textarea name="deskripsi" cols="50" rows="10" placeholder="Deskripsi"><?php echo $deskripsi; ?></textarea></td>
                    </tr><br>
                    ...
                    <div class="btn">
                        <tr>
                            <td>
                                ...
                                <a href="#"><input type="submit" value="Perbarui" /></a>
